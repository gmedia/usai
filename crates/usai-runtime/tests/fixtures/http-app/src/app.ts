...
export const getUser = http.get("/users/:id", { summary: "One user", description: "By id, with the page the caller asked for.", params: Params, query: Query, response: { 200: User }, errors: [{ code: "not_found", status: 404 }] }, async (ctx) => {
