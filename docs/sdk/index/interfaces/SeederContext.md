[@sakaladev/usai](../../README.md) / [index](../README.md) / SeederContext

# Interface: SeederContext\<R = [`ResourceDeclaration`](ResourceDeclaration.md)[]\>

The context a seeder runs with: [BaseContext](BaseContext.md).
