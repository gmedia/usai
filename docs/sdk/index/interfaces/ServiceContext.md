[@sakaladev/usai](../../README.md) / [index](../README.md) / ServiceContext

# Interface: ServiceContext\<R = [`ResourceDeclaration`](ResourceDeclaration.md)[]\>

The context of a service: [BaseContext](BaseContext.md) plus `sleep`. Watch
