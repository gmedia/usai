[@sakaladev/usai](../../README.md) / [index](../README.md) / CommandContext

# Interface: CommandContext\<R = [`ResourceDeclaration`](ResourceDeclaration.md)[]\>
...
| <a id="args"></a> `args` | `readonly` | `string`[] | - | - | - |
