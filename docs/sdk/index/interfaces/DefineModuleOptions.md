...
| <a id="resources"></a> `resources?` | [`ResourceDeclaration`](ResourceDeclaration.md)[] | Resources this module declares; the same resource may be declared by several modules with identical configuration. |
