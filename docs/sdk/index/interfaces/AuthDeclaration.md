...
# Interface: AuthDeclaration\<Principal = `unknown`, R *extends* readonly [`ResourceDeclaration`](ResourceDeclaration.md)[] = readonly [`ResourceDeclaration`](ResourceDeclaration.md)[]\>
...
| ------ | ------ |
| `Principal` | `unknown` |
| `R` *extends* readonly [`ResourceDeclaration`](ResourceDeclaration.md)[] | readonly [`ResourceDeclaration`](ResourceDeclaration.md)[] |
